 ...
 */
public class Person implements IModelAttribute
{
    /*
     * Logger
     */
    ...
    private final String ATTR_PROFILE_PATH = "profile_path";
    private final String ATTR_ADULT = "adult";
    private final String ATTR_ALSO_KNOWN_AS = "also_known_as";
    private final String ATTR_BIOGRAPHY = "biography";
    private final String ATTR_BIRTHDAY = "birthday";
    private final String ATTR_DEATHDAY = "deathday";
    private final String ATTR_HOMEPAGE = "homepage";
    private final String ATTR_PLACE_OF_BIRTH = "place_of_birth";
    ...
    */
    ...
    private String name = "";
    @JsonProperty(ATTR_PROFILE_PATH)
